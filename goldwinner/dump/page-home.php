					...
					<?php
						...
						?>			
								<?php if($count==1){ $count++; ?>
									...
									?>
								<?php }else{ $count++; ?>
									<h1 class="side-heading color-red margin-top-50 margin-bottom-10"><?php the_title(); ?></h1>
									<?php the_content(); ?>
									<?php
										$args=array(
...
<section id="tvc-video-section">
	<div class="container-fluid">
		<div class='embed-container'><iframe width="100%" height="auto" src="https://www.youtube-nocookie.com/embed/U7f6gvTxwIU?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe></div> 
